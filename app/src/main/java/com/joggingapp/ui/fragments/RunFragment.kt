...
import com.joggingapp.other.SortType
...
class RunFragment : Fragment(R.layout.fragment_run), EasyPermissions.PermissionCallbacks {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (viewModel.sortType) {
            SortType.DATE -> spinner_filter.setSelection(0)
            SortType.RUNNING_TIME -> spinner_filter.setSelection(1)
            SortType.DISTANCE -> spinner_filter.setSelection(2)
            SortType.AVG_SPEED -> spinner_filter.setSelection(3)
            SortType.CALORIES_BURNED -> spinner_filter.setSelection(4)
        }
